...
function Header()
{
	...
	if ($orientation == "L")
	{	if ($_REQUEST['forma'] == "Letter")
		{	$this->Image ("themes/bord_LE_paysage.jpg", 0, 0);
		} else
		{	$this->Image ("themes/bord_A4_paysage.jpg", 0, 0);
		}
	} else
	{	if ($_REQUEST['forma'] == "Letter")
		{	$this->Image ("themes/bord_LE_portrait.jpg", 0, 0);
		} else
		{	$this->Image ("themes/bord_A4_portrait.jpg", 0, 0);
		}
	}
	...
	$this->cell (0,4,$entete,0,0,"C");
	$this->SetFont('Arial','',7);
	$this->Cell(0,4,'Page '.$this->PageNo(),0,1,"R");
	$this->SetFont('DejaVu','',12);
...
function Footer()
{
	...
	$this->SetFont('Arial','',7);
	$this->SetTextColor (0,0,0);
	$this->cell (0,3,strftime("%A %d %B %Y", time()) );
}
