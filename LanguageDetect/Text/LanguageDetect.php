...
require_once 'LanguageDetect/Text/LanguageDetect/Exception.php';
require_once 'LanguageDetect/Text/LanguageDetect/Parser.php';
require_once 'LanguageDetect/Text/LanguageDetect/ISO639.php';
...
class Text_LanguageDetect
{
    ...
    protected function _get_data_loc($fname)
    {
        if ($fname[0] == '/' || $fname[0] == '.') {
            ...
            return $parent . DIRECTORY_SEPARATOR . 'data/'.$fname;
        }
    }
